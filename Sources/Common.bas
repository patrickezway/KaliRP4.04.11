...
Public p_ModePublication As String
Public p_Command As String
Public p_boolChoisirModeleFichier As Boolean
Public p_boolRechargerModeleAuto As Boolean
...
Public Function FctTrace(str As String)
    Dim fpOut As Integer
    Dim NomFichierOut As String
    
    If p_Mode_FctTrace Then
        Call LOG_INF("KaliRP", str)
        Exit Function
        fpOut = FreeFile
        FICH_OuvrirFichier p_Chemin_FichierTrace, FICH_ECRITURE, fpOut
        Print #fpOut, Date & " " & Time & " " & str
        Close #fpOut
    End If
End Function
