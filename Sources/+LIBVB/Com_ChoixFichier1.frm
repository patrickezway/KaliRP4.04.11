VERSION 5.00
Begin VB.Form Com_ChoixFichier1 
   BackColor       =   &H00E0E0E0&
   ...
   Begin VB.Frame frm 
      ...
      Begin VB.PictureBox pct 
         ...
         Index           =   1
         Left            =   4920
         Picture         =   "Com_ChoixFichier1.frx":0000
         ScaleHeight     =   345
         ScaleWidth      =   375
         TabIndex        =   10
         Top             =   3600
      ...
      Begin VB.PictureBox pct 
         ...
         Index           =   0
         Left            =   1740
         Picture         =   "Com_ChoixFichier1.frx":0876
         ScaleHeight     =   345
         ScaleWidth      =   375
         TabIndex        =   7
         Top             =   1440
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.CommandButton cmd 
         ...
         Index           =   1
         Left            =   8970
         Picture         =   "Com_ChoixFichier1.frx":10EC
         Style           =   1  'Graphical
         TabIndex        =   2
      ...
      Begin VB.CommandButton cmd 
         ...
         Index           =   0
         Left            =   2040
         Picture         =   "Com_ChoixFichier1.frx":16A5
         Style           =   1  'Graphical
         TabIndex        =   1
         ToolTipText     =   "Valider le choix"
         Top             =   240
         UseMaskColor    =   -1  'True
         Width           =   550
      End
   End
End
Attribute VB_Name = "Com_ChoixFichier1"
...
lab_no_drv:
    On Error GoTo 0
    MsgBox "Ce lecteur n'est pas disponible.", vbInformation + vbOKOnly, ""
