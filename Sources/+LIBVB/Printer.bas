...
Private g_posx As Long, g_posy As Long
...
Public Sub PR_ImpLigne(ByRef v_textes() As String)
    ...
    Dim str As String
    Dim i As Integer
    Dim posx As Long, posy As Long, pos As Long
    Dim vcol As Variant
...
Public Sub PR_InitFormat(ByVal v_sizefont As Integer, _
                         ByVal v_binit As Boolean, _
    ...
    Dim s As String
    Dim n As Integer, i As Integer, width As Integer
    Dim lg_tot As Long
    
    Printer.FontSize = v_sizefont
